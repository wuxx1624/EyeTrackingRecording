...
namespace Sigtrap.VrTunnellingPro {
	...
	public abstract class TunnellingPresetBase : ScriptableObject {
        ...
        [SerializeField][Range(0f, 1f)]
        float _effectCoverage_x = 0.75f;
        [SerializeField][Range(0f, 1f)]
        float _effectCoverage_y = 0.75f;
        [SerializeField]
        ...
        public float effectCoverage_x { get { return _effectCoverage_x; } }
        public float effectCoverage_y { get { return _effectCoverage_y; } }
