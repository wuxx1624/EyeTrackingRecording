...
namespace Sigtrap.VrTunnellingPro.Editors {
	public abstract class VrTunnellingProPresetEditorBase : Editor {
        ...
        protected SerializedPropertyPair _pEffectCoverage_x;
        protected SerializedPropertyPair _pEffectCoverage_y;
		...
		void OnEnable(){
            ...
            _pEffectCoverage_x = new SerializedPropertyPair(serializedObject, "_effectCoverage_x");
            _pEffectCoverage_y = new SerializedPropertyPair(serializedObject, "_effectCoverage_y");
